...
class CampusEmployeeAttendanceController extends Controller
{
    public function choose_month(Request $request)
    {
        ...
        return view(
            'campus_admin_panel.dashboard.Campus_General_Operations.campus_hr_screen.campus_employee_attendance.choose_month',
            [
                'pagename'      => $pagename,
    ...
    public function fetch_employee_attendance(Request $request)
    {
        ...
        $employees_attendance_data = DB::table('campus_employee_attendances')
            ...
            ->toArray();
        return view(
            'campus_admin_panel.dashboard.Campus_General_Operations.campus_hr_screen.campus_employee_attendance.employee_attendance',
            [
                'pagename' => $pagename,
    ...
    public function choose_daily_att(Request $request)
    {
        ...
        return view(
            'campus_admin_panel.dashboard.Campus_General_operations.campus_hr_screen.campus_employee_record.daily_attendance.choose_daily_att',
            [
                'pagename'      => $pagename,
    ...
    public function fetch_employee_attendance_record(Request $request)
    {
        ...
        return view(
            'campus_admin_panel.dashboard.Campus_General_operations.campus_hr_screen.campus_employee_record.daily_attendance.list_employee_attendance_record',
            [
                'pagename'                => $pagename,
    ...
    public function choose_month_employee(Request $request)
    {
        ...
        $all_departments = CampusDepartment::where('institute_id', $Institute_admin_id)->where('campus_id', $campus_id)->get();
        return view(
            'campus_admin_panel.dashboard.Campus_General_operations.campus_hr_screen.campus_employee_record.monthly_attendance.choose_month_employee',
            [
                'pagename'           => $pagename,
                'all_departments'    => $all_departments,
            ]
    ...
    public function employee_monthly_attendance_record(Request $request)
    {
        ...
        // dd($present_count);
        return view(
            'campus_admin_panel.dashboard.Campus_General_operations.campus_hr_screen.campus_employee_record.monthly_attendance.employee_monthly_attendance_record',
            [
                'pagename'                => $pagename,
                'attendance_records'      => $attendance_records,
    ...
    public function individual_employee_attendance(Request $request, $id, $dep, $at_date, $total_month_days)
    {
        ...
        return view(
            'campus_admin_panel.dashboard.Campus_General_operations.campus_hr_screen.campus_employee_record.monthly_attendance.individual_employee_attendance',
            [
