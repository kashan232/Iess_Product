...
class CampusTeacherStudentAttendance extends Controller
{
    ...
    public function student_attendance(Request $request)
    {
        ...
        return view(
            'teacher_panel.attendance_work.student_attendance.all_student_attendance',
            [
                'pagename' => $pagename,
                'classes' => $classes,
            ]
    ...
    public function student_attendance_record(Request $request)
    {
        ...
        $classes = CampusClass::where('institute_id', $institute_id)
            ...
            ->get();
        return view(
            'teacher_panel.attendance_work.attendance_record.all_student_attendance_record',
            [
                'pagename' => $pagename,
                'classes' => $classes,
            ]
    ...
    public function fetch_student_attendance_record(Request $request)
    {
        ...
        return view(
            'teacher_panel.attendance_work.attendance_record.list_student_attendance_record',
            [
                'pagename' => $pagename,
