    ...
    <div class="dashboard-page-one">
        <div class="dashboard-content-one">
            ...
            <div class="container-fluid card height-auto">
                <div class="card-body">
                        @if(@session('success-message-leave-add'))
                            <div class="alert alert-success">
                                <strong>Congratulations! </strong> {{ @session('success-message-leave-add') }}
                            </div>
                        @endif
                    ...
                    <form id="course_uploaded_document" class="new-added-form" action="{{ route('store-add-leave') }}" method="POST" 
                    enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-xl-4 col-lg-6 col-12 form-group">
                                ...
                                <input type="date" name="apply_date" id="apply_date" value="YYYY-MM-DD"
                                    placeholder="Apply Date" required class="form-control" />
                            </div>
                            <div class="col-xl-4 col-lg-6 col-12 form-group">
                                <label for="">From Date*</label>
                                
                                <input type="date" name="from_date" id="from_date" placeholder=".." required
                                    class="form-control" />
                            </div>
                            <div class="col-xl-4 col-lg-6 col-12 form-group">
                                <label for="">To Date*</label>
                                <input type="date" name="to_date" id="to_date" placeholder=".." required
                                    class="form-control" />
                            </div>
                        </div>
                        <div class="row mt-3 mb-3 mg-t-6">
                            <div class="col-xl-12 col-lg-12 col-12 form-group">
                                ...
                                <textarea type="textarea" name="leave_reason" class="form-control" id="diary" placeholder="Enter Your Reason"></textarea>
                            </div>
                        </div>
                        <div class="row mt-3 mb-3 mg-t-6">
                            <div class="col-xl-12 col-lg-12 col-12 form-group ">
