                ...
                <div class="card-body">
                    ...
                    <form class="new-added-form" action="{{ route('store-add-employees') }}" method="POST">
                        ...
                        <div class="col-xl-4 col-lg-6 col-12 form-group">
                                ...
                                <input type="text" name="account_name" id="no_of_leaves" placeholder="account name"
                                    class="form-control" />
                            </div>

                            <div class="col-xl-4 col-lg-6 col-12 form-group">
                                <label>Account Number*</label>
                                <input type="number" name="account_number" id="no_of_leaves" placeholder="account Number"
                                    class="form-control" />
                            </div>
