    ...
    <div class="dlabnav-scroll">
        <ul class="metismenu" id="menu">
            ...
            <li>
                ...
                <ul aria-expanded="false">
                    <li><a href="all-professors.html">All Employee</a></li>
                    <li><a href="add-professor.html">Add Employee</a></li>
                </ul>
            </li>
            ...
            <li>
                ...
                <ul aria-expanded="false">
                    <li><a href="all-professors.html">All Department</a></li>
                    <li><a href="add-professor.html">Add Department</a></li>
                </ul>
            </li>
        </ul>
    </div>
